                ...
                ? ListView.builder(
                    ...
                    itemBuilder: (context, int index) {
                      getDays = (DateTime.now()
                              .difference(
                                  data.docs[index]["booking_date"].toDate())
                              .inDays)
                          .toString();

                      totalDays = (data.docs[index]["plan_end_duration"]
                          .toDate()
                          .difference(data.docs[index]["booking_date"].toDate())
                          .inDays);
                        ...
                        return Card(
                            ...
                            child:
                              ...
                              children: [
                                ...
                                Positioned(
                                  right:
                                      MediaQuery.of(context).size.width * .0895,
                                  bottom: 53,
                                  child: Text(
                                    "${percent}%",
                                    style: GoogleFonts.poppins(
