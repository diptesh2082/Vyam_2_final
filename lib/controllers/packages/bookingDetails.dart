                                      ...
                                      children: [
                                        ...
                                        Text(
                                          description.toString() == ""
                                              ? "Note - if you book for an off-day, don't worry it will get adjusted."
                                              : "${description.toString()}",
                                          style: GoogleFonts.poppins(
                                              fontSize: 14,
                                              color: HexColor("3A3A3A"),
                                              ...
                                              await FirebaseFirestore.instance
                                                ...
                                                "booking_plan":
                                                    newBookingList[index]
                                                        ['title'],
                                                "booking_price": bookingList[index]
                                                            ["ptype"] ==
                                                        true
                                                    ? (int.parse(bookingList[index]["original_price"]) -
                                                        (int.parse(bookingList[index]["original_price"]) *
                                                  ...
                                                  Get.to(
                                                    () => DatePickerScreen(
                                                        ...
                                                        price: bookingList[index]
                                                                ...
                                                                true
                                                            ? (int.parse(bookingList[index]["original_price"]) -
                                                                (int.parse(bookingList[index]["original_price"]) * int.parse(bookingList[index]["discount"]) / 100)
                                                                    .round())
                                                            : (int.parse(bookingList[index]["original_price"]) -
                                                        ...
                                                        gymId: gymID,
                                                        bookingId: booking_id,
                                                        package_name: bookingList[index]['title'],
                                                        branch: branch),
                                                    arguments: {"docs": docs},
                                                    duration: const Duration(
                                                        milliseconds: 700),
